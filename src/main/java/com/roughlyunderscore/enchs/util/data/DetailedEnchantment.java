...
public class DetailedEnchantment {
  ...
  public DetailedEnchantment(String key) {
    switch (key.toLowerCase(Locale.ROOT)) {
      case "wrong_level", "wrong_name" ->
        this.key = NamespacedKey.minecraft(key.toLowerCase(Locale.ROOT) + "_underscore_enchants");
      default ->
        throw new IllegalArgumentException("DetailedEnchantment was attempted to be initialized with an unknown string value: " + key);
    }
  }
