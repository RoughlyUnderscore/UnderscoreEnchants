...
public enum DoublePlayerActions {
  ...
  PLAYER_TWO_SET_MONEY("player-two-set-money", "player-two-money-set", "player-two-money-set", "player-two-set-money", "player-two-produce-money", "player-two-money", "player-two-set-money-level", "player-two-money-level-set", "player-two-money-level-set", "player-two-set-money-level", "player-two-produce-money-level", "player-two-balance", "player-two-set-balance", "player-two-balance-set", "player-two-set-balance", "player-two-produce-balance"),
