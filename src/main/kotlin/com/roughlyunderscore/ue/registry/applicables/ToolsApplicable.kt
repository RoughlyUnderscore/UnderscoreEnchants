...
@Since("2.2")
@Stable
class ToolsApplicable : RegistrableApplicable {
  override val aliases = listOf("tools", "tool")

  override fun canBeAppliedTo(type: Material): Boolean = type in Constants.TOOLS
}