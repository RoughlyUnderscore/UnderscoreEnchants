...
@Since("2.2")
@Stable
class HoesApplicable : RegistrableApplicable {
  override val aliases = listOf("hoe", "hoes")

  override fun canBeAppliedTo(type: Material): Boolean = type in Constants.HOES
}