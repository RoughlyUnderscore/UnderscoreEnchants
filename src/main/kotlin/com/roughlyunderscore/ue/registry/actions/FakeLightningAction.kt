...
/**
 * Strikes a fake lightning at the entity's current position
 *
 * Syntax:
 * - `fake-lightning`
 */
@Since("2.2")
@Stable
class FakeLightningAction : RegistrableAction {
  override val aliases = listOf("fake-lightning", "strike-fake-lightning")
