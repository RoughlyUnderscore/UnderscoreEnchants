...
@Since("2.2")
@Stable
class RemoveBuffsAction : RegistrableAction {
  override val aliases = listOf("remove-buffs", "take-buffs")
  ...
  override fun execute(event: Event, trigger: RegistrableTrigger, arguments: List<String>, target: TargetType): EventModifications? {
    ...
    Constants.BUFFS.forEach { potionEffectType -> entity.removePotionEffect(potionEffectType) }
