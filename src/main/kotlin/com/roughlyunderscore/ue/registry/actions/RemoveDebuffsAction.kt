...
@Since("2.2")
@Stable
class RemoveDebuffsAction : RegistrableAction {
  override val aliases = listOf("remove-debuffs", "take-debuffs")
  ...
  override fun execute(event: Event, trigger: RegistrableTrigger, arguments: List<String>, target: TargetType): EventModifications? {
    ...
    Constants.DEBUFFS.forEach { potionEffectType -> entity.removePotionEffect(potionEffectType) }
