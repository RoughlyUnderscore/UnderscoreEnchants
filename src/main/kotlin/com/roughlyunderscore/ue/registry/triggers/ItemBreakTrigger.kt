...
@Since("2.2")
@Stable
class ItemBreakTrigger : RegistrableTrigger {
  override val aliases = listOf("itembreak", "item-break", "itembreakevent", "item-break-event")

  override fun getTriggerDataHolder(): TriggerDataHolder = TriggerDataHolder.fromStringMethods(
    PlayerItemBreakEvent::class.java,
    DataRetrievalType.FIRST_PLAYER to "getPlayer",
    DataRetrievalType.FIRST_ITEM to "getBrokenItem",
  )
}