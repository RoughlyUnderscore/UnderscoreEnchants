...
@Since("2.2")
@Stable
class RMBEntityTrigger : RegistrableTrigger {
  override val aliases = listOf("rmbentity", "rightclickentity", "rightclickentityevent")
  ...
  override fun getTriggerDataHolder(): TriggerDataHolder = TriggerDataHolder.fromStringMethods(
    ...
    DataRetrievalType.ENTITY to "getRightClicked",
  )
}