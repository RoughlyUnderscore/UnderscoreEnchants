...
@Since("2.2")
@Stable
class ItemEatTrigger : RegistrableTrigger {
  override val aliases = listOf("item-eat", "itemeat", "itemconsume", "item-consume", "itemconsumeevent", "item-consume-event")
  ...
  override fun getTriggerDataHolder(): TriggerDataHolder = TriggerDataHolder.fromStringMethods(
    ...
    DataRetrievalType.FIRST_ITEM to "getItem",
  )
}