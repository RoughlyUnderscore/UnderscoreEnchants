...
@Since("2.2")
@Stable
class PlayerHurtsEntityTrigger : RegistrableTrigger {
  override val aliases = listOf("playerhurtsentity", "playerhurtentity", "playerhurtentityevent")

  override fun getTriggerDataHolder(): TriggerDataHolder = TriggerDataHolder.fromStringMethods(
    PlayerHurtEntityEvent::class.java,
    DataRetrievalType.FIRST_PLAYER to "getDamager",
    DataRetrievalType.ENTITY to "getVictim",
