...
@Since("2.2")
@Stable
class PlayerShootBowTrigger : RegistrableTrigger {
  override val aliases = listOf("playershootbow", "playershootbowevent")

  override fun getTriggerDataHolder(): TriggerDataHolder = TriggerDataHolder.fromStringMethods(
    PlayerShootBowEvent::class.java,
    DataRetrievalType.FIRST_PLAYER to "getShooter",
  )
}