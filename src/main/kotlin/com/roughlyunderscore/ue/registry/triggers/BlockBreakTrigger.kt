...
@Since("2.2")
@Stable
class BlockBreakTrigger : RegistrableTrigger {
  override val aliases = listOf("blockbreak", "block-break", "blockbreak-event", "block-break-event")
  ...
  override fun getTriggerDataHolder(): TriggerDataHolder = TriggerDataHolder.fromStringMethods(
    ...
    DataRetrievalType.BLOCK to "getBlock",
  )
}