...
@Since("2.2")
@Stable
class MessageIndicator : RegistrableActivationIndicator {
  override val aliases = listOf("message", "msg", "text")

  override fun indicateAboutActivation(text: String, player: Player) {
    player.sendMessage(PlaceholderAPI.setPlaceholders(player, text))
  }
}